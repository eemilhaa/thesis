...
\title{Interactive maps as a tool for visualising multimodal place-based accessibility}
...
with all further meaning derived from additional explanations and the context in which the word is used.
In this thesis, when referring to accessibility, I more specifically mean spatial accessibility,
...
In this geographical sense, the general starting point for defining accessibility is often
...
would make the amount of variations to measure grow exponentially \parencite{lev2020}.
...
% 1950-1990
\textcite{mac2004} considers two developments as being especially important
to the development of cartographical research in the latter half of the 20th century.

The first, set in motion by the second world war, was the shift from
thinking of maps as primarily objects of art and graphic design,
to focusing instead on the function of maps.
This resulted in cartographic research focusing on finding as objective as possible rules
for 

% The second - 1970
Cartography as graphic communication.
The mappers knowledge is disseminated through a map,
rather than new knowledge constructed by the map reader.
