...
a map is essentially just means to trasnport knowledge.
So, the knowledge a map reader gains from reading a map is
the mapper's knowledge of the mapped phenomenon
disseminated through cartographical communication, i.e. the map.
Thinking this way, no new knowledge constructed by the map reader.  % TODO check this & debunk later
