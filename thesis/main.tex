...
\makenoidxglossaries
\renewcommand{\glsnamefont}[1]{\textsf{#1}}  % sans serif glossaries
...
% \usepackage{caption}
\usepackage[font={small, sf}]{caption}  % sans serif captions
...
\sffamily  % sans serif for title page & abstract
...
\normalfont  % resume normal font for rest of the thesis
