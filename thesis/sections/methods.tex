...
the web mapping library must allow for user-map interactions to be
...
As mentioned in section \ref{Web maps and web technologies},
...
I used each of them as the map interface of the application. % ref frontend fig here?
...
and a way to alter one piece of application state: the mapped location.
Aside from these two aspects, the map component was completely encapsulated
...
For an overview of the frontend, see figure \ref{fig:frontend}.
...
I assessed visual quality of the map qualitatively, and,
...
as well as the finished frontend implementation.
