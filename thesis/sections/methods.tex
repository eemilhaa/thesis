...
In table \ref{tab:functional requirements}
I specify the desired capabilities of the map interface,
in table \ref{tab:quality attributes}
I specify the desired qualities of the system,
and in table \ref{tab:constraints}
I specify the relevant constraints.
