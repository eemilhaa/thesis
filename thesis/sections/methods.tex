...
and to compare the effectiveness of different methods.
...
They either dissolved multiple grid cell geometries into larger polygons \parenfig{isochrone intervals},
...
For these reasons, I carried out the aforementioned assessment in two iterations:
