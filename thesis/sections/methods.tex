...
the web mapping library must allow for user interactions to be
...
I used each library as the map interface with the application. % ref frontend fig here?
To minimize the changes outside of map library, modularity ...
