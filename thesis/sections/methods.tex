...
needed to enable and deploy the web map application.
...
I implemented the backend as minimally as possible,
...
More sophisticated solutions such as a spatial database,
while more conventional, were not needed in this particular case,
and would have introduced computational overhead as well as increase the complexity of the application.
