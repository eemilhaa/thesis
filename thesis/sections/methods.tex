...
It only included a drop-down menu for selecting travel modes, and a legend.
For a visual overview of the map interface see figure \ref{fig:frontend screenshot},
and for the architechture of the frontend application see figure \ref{fig:frontend screenshot}.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{visual/figures/screenshots/frontend.png}
	\caption{
