...
\begin{figure}[H]
	...
	\caption{
		...
		Four examples are shown here, from no simplification (\ref{fig:interval 1})
		to a highly simplified presentation (\ref{fig:interval 30}).
	}
...
\begin{figure}[H]
	...
	\caption{
		...
		Limiting the maximum travel time reduces the spatial extent of data,
