...
\subsection{Implementation of the web map application}
...
These included clicking the map with a pointing device to \enquote{lock} the map on the clicked location,
...
as they both were deployed with the OpenShift flavour of Kubernetes.
...
servers was the OpenShift \parencite{openshift} container orchestration platform.
