...
% As instantaneous interaction is a requirement of the presentation,
% I aimed to make all simplifications to the data precalculated.
% This means that the map application is computationally lighter,
% and that all preprocessing must only be done once
% per any given combination of location and travel mode in a \acrshort{ttm}.  % TO
