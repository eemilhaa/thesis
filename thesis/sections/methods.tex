...
These include \textit{clicking} the map with a pointing device to produce a map of the clicked location,
...
a \textit{clicking mode} to produce static maps,
and a \textit{hovering mode} to produce
an interactive, live,
