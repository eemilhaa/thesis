...
and how the interactive map works as a representation.
The survey was carried out with an online questionnaire.
...
This task-question cycle can then be repeated to gain insight on the participants'
...
and it is commonly used especially in the context of
\acrshort{hci} and \acrshort{ue} research
when studying user interaction with interfaces.
