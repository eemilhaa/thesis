...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\caption{Isochrone interval = 10 minutes}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\caption{Isochrone interval = 20 minutes}
...
that the simplified data covers.
These areas are, again, averages of a random sample as described above.
