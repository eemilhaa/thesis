...
Drawing inspiration from studies in information sciences,
...
With advances such as computer-stored spatial data,
computer-assisted spatial modelling, and, eventually,
computer graphics, the function of maps widened.
As a result, the paradigm of cartographic communication was soon found quite limiting.
For example, if the acts of making and reading maps are strictly related to
...
as exploratory and analytical devices \parencite{tob1976},
this was not necessarily the most fitting way of thinking of them.
Considering the concept of map function,
Often the mapmaker and reader were the same person,
and the purpose of the map was not strictly to communicate but also to facilitate thinking
-- in other words produce new knowledge.
At first called analytical cartograpghy 
Computer graphics into geographic visualisation
