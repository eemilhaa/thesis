...
The previous definition of cartographic interaction has three components:
...
and integrating and reasoning about different insights and results (synthesis) \parencite{mac2017, dib1990, rot2015}.
...
while the stages of synthesis and presentation have classically been seen to employ static presentations
(figure \ref{fig:analytical process interaction}) \parencite{dib1990}.
While at the theoretical level it is the capability of visual exploration and analysing that is
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{visual/figures/diagrams/swoopy.png}
	\caption{
...
So far it is clear that the applications of interactive maps are numerous.
However, not all interactive maps are the same, and their scopes and types of interaction
vary based on many things such as intended use as well as % TODO
