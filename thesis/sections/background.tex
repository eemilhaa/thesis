...
The cartographic visualization paradigm is thriving,
...
in enabling dialogue between computers and humans \parencite{car1997}.
...
contexts of dialogue, but also on people’s perceptions \parencite{kio2002}.
...
and that interaction has been the norm of making and understanding maps
before they were transformed into static artefacts,
be it paper or digital images.
...
This is arguably the most relevant approach considering
...
SIDENOTE: I think a picture from the tutkijoiden yö workshop showing the digital interactive map
and the physical, hands-on interactive map
would be such a perfect visual analogy to highlight two different types of interactive maps here.
Would you Tuuli or Chris happen to have such a picture? I don't :(
...
Arguably, there is a fourth component too: the dialogue.
...
the components of cartographic interaction further motivate and call for
multidisciplinary approaches in cartography.
...
Close with interactive maps in more detail:
...
The success of the web-based application (in general and in the context of maps)

The relevant terms and software architechture (in web context):
At least concepts of front / backend and server requests / responses
