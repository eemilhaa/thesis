...
many of which proved relevant to cartography --
for example in the form of computer-stored spatial data,
...
-- in other words produce new knowledge \parencite{tob2000}.
At first called analytical cartograpghy \parencite{tob1976},
