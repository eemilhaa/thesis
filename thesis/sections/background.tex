...
as the result is again a single value that can be mapped.  % TODO ref
...
% Also, it should be noted that some measures of access are
% unquantifiable
% At a general level, accessibility is an invisible phenomenon,
% and is not necessarily tied to any concrete features found in a l
