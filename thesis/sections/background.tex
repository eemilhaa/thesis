...
mathematics is a one example of a science essential to mapmaking,
and thus to cartography as well.
...
The method this transformation is carried out, is a map projection.  % FIXME this line, add refs
The effects of this transformation vary by
the used projection and the scale of the map,
...
% The role of mathematics if also significant when considering many essential methods of map
