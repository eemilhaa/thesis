...
enable a dialogue by enabling and adapting to manipulation by the map user.
...
As an added level of detail, operator primitives are split into primitives that
...
Level in this context means the scope of the operation:
