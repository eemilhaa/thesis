...
A desktop \acrshort{gis} software could represent the former type of interface \ref{fig:qgis},
and a simple web map the latter \ref{fig:simple web map}.
...
\begin{figure}[H]
	...
	\caption{
		The UI of the Geographic Information System QGIS \parencite{qgis}.
		GIS software often supports a wide array of interaction styles:
