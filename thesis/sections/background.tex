...
\subsubsection{Perspectives and disciplines relevant to cartographic interaction}
...
\subsubsection{Components of cartographic interaction and map interfaces}
...
interactive maps and the cartographic interactions they enable
...
interaction in analytical processes.
...
While, again, such efforts have been carried out previously,
...
Interaction primitives are grouped into
\textit{objectives}, \textit{operators} and \textit{operands} as already specified above,
with the addition of user \textit{goals} as a broader context for the primitives
\parencite{rot2013a}.
