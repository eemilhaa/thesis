...
Currently, as defined by the \acrlong{ica} (\acrshort{ica}), "Cartography is
the science, art, and technology of making and using maps."
\parencite{ica2019}.

% TODO cartography history here instead?

% Why is cartography that way? (history)
...
this definition has received its fair share of critique as well.
...
It would limit maps to depicting earth only
...
arriving at the following definition:
\enquote{a map is a generalized representation of spatial relationships}.
Years earlier, \textcite{tyn2014} shared much of the same sentiments,
defining a map as \enquote{a graphic representation that shows spatial relationships}.
While \citeauthor{tyn2014} specifies maps as something graphic,
