...
instead of a passive map reader \parencite{rot2013b}.
...
that the medium through which people interact with maps today
is increasingly digital \parencite{mei2019}.
...
Considering this definition of cartographic interaction,
I deduce that, in the context of this study,
an interactive map is a digital map
that can be manipulated by the map user.
...
and the computing device as the technology that enables the presentation.
Map interaction can be studied from many perspectives
...
Human-computer interaction, information visualization, usability engineering, and visual analytics \parencite{rot2015}
