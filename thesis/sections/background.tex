...
\begin{figure}[H]
	...
	\caption{
		...
		Cartographic interaction happens by manipulating the map with post-it-notes and annotations.
		The map is also constructed through a process of
...
\begin{figure}[H]
	...
	\caption{
		A digital interactive map about travel times.
		The user can alter the map by  ... TODO
	}
