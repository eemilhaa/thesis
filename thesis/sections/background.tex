...
In a scientific context, a \textit{digital environment} can refer to either
an artificial computer-created scene \parencite{kon2011},
or the more general ecosystem of digital tools, systems and resources.  % TODO ref
Here, I use the term in the latter sense to provide a basis for the technological
aspects of crafting an interactive map.
...
the attributes of these devices are enabling as well as limiting factors of
...
in short it acts as a \acrshort{ui} of a system.
User actions
...
In software architecture, such logic is a concern separate from presentation,
...
The above paragraph showed what a system is made of.
However, 


% Program, library, application
Such maps are often referred to map applications
These include, for example, the necessary physical infrastructure
(such as computer hardware and input and output devices),
software (computer programs) and digital data.

this technological perspective in addition
what kinds of interaction and representation digital environments enable,
as well as what the advantages and restrictions of such environments are.
As the above chapter provided
These capabilities would be a list 
...
% an overview of the
% tools available to the interactive cartographer.
