...
\textit{how} interactions are carried out at the level of the interface --
in other words, how the different types of interaction are provided to the user.
...
Interaction styles are often categorized into 4 main types:
