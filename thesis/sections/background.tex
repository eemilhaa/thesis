...
In addition to improving the function of maps,
psychology is also essential to conceptualizing \textit{how} maps function.
As already hinted in the work of \textcite{rob1952},
the initial concept of map function was strongly linked to communication. \parencite{gri2017}:
