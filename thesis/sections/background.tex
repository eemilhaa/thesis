...
Web mapping refers to the process of making maps for the web platform, with web technologies.
Thus, a web map is a map that is published and accessed
on the internet as a component of a web-page \parencite{sac2017}.

% rot2014 conclusions: technologies evaluation is necessary
