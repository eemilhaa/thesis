...
which compares how two map applications,
one implemented as a server-side dynamic web page (REF)
and the other as a \acrshort{spa} (REF)
respond when a user changes the content of the map.
