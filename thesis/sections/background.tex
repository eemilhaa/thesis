...
is based on \citeauthor{nor1988}'s (\citeyear{nor1988})
...
Another aspect worth noting in \citeauthor{rot2011}'s (\citeyear{rot2011}) definition
...
\begin{figure}[H]
	...
	\caption{
		...
		\citeauthor{nor1988}'s (\citeyear{nor1988})
...
their potential in presenting known insights (for example \textcite{}),
as opposed to only revealing new ones through exploration,
has been recognized and growingly applied \parencite{}.
This proliferation of cartographic interaction is also visible in the state of mapmaking:
in practice, interactivity is increasingly utilized
...
What exactly an interactive map is, can vary greatly depending on what the purpose of the map is.
As is clear based on the above,
the applications of cartographic interaction are immensely diverse,
and so are different types of map interfaces.
Conceptualizing -> interaction primitives -> examples
