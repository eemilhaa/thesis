...
The method this transformation is carried out, is a map projection.  % FIXME
The effects of this transformation vary by projection and scale, but
are always present as distortions introduced to the map.
