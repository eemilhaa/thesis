...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.7\textwidth}
		\centering
		\includegraphics[width=\textwidth]{visual/figures/ttm/isochrone_lines.pdf}
		\caption{}
		\label{fig:isochrone lines}
	\end{subfigure}
	\begin{subfigure}[b]{0.7\textwidth}
		\centering
		\includegraphics[width=\textwidth]{visual/figures/ttm/isochrone_areas.pdf}
		\caption{}
