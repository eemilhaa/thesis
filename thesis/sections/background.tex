...
\begin{figure}[H]
	...
	\caption{
		A paper map about how people experience travel in urban space.
		Constructed interactively in a workshop setting,
...
\begin{figure}[H]
	...
	\caption{
		A digital map about travel times.
		Cartographic interaction happens through a graphical UI,
		Where the map can be directly manipulated for example by panning and zooming.
	}
