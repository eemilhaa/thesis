...
\begin{figure}[H]
	...
	\caption{
		...
		Here the process of mapmaking is also a collaborative one,
...
The research, theories and methods in \acrshort{hci} and \acrshort{ue}
have been perhaps the most visible influences
interactivity has introduced to the discipline of cartography \parencite{rot2017}.
These methods can for example be empirical approaches such as
data generation through
system-level logging of user interactions with map-based interfaces \parencite{oom2015},
or technology centred such as the study of different input devices in interacting with maps.
As maps become interfaces, \acrshort{ui} and \acrshort{ux} design becomes part
of the process of mapmaking
