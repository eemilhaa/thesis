...
The web as a platform is a rapidly changing one, and, consequently,
so are web maps as well as
the technological landscape relevant to web mapping.
Initially defined solely by the capability of file sharing through
interconnected computer networks (the internet),
the web today is a platform for increasingly complex systems and applications.
In the case of web mapping, the concept of a web map has gone
...
and read and used and as a web-page \parencite{sac2017}.
