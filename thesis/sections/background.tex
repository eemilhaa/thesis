...
\subsubsection{Defining \enquote{accessibility}}
...
Considering the two aforementioned explanations for the term,
...
Consequently,
definitions and measures of accessibility can be constructed in highly diverse ways
\parencite{pap2016}.
In a review of such measures,
\textcite{geu2004} arrive at four components that make up accessibility:
...
All the aforementioned aspects of accessibility change depending on time,
...
Different perspectives into measuring access have been
grouped based on various aspects, in many studies and within multiple disciplines \parencite{wu2020}.
One often seen distinction in categorizing accessibility measures
is the notion of location-based versus person-based approach.
% Location based is macro scale
...
the temporal variance of the phenomenon \parencite{neu2012, neu2011}.
Of course, accessibility measures can also inhibit characteristics of both types \parencite{jar2018}.
A key takeaway here is that a given accessibility measure is ultimately
...
Implications in presenting the phenomenon.

% single measure thematic mapping
