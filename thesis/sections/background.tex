...
This setting first began to change with
...
This was a new degree of interactivity and also enabled the first interactive web maps,
...
turning websites from documents
into software, often called web applications \parencite{jac2019}.
...
since most user interactions with them result in client-server communication,
for example fetching tiled base maps, or new data to be mapped
\parencite{mai2017}.
The importance of \acrshort{spa} design is further illustrated in REF,
which compares how map applications implemented as a server-side dynamic web page (REF)
and as a \acrshort{spa} (REF) respond when a user changes the content of the map.
