...
from singular static maps sent as images, to
...
and \acrshort{http} refers to a set of protocols for fetching resources over the internet,
for example \acrshort{html} documents \parencite{ietfhttp1, ietfhttp2, ietfhttp3}.
These resources are fetched by a client, from a server --
...
This is a requirement for \textit{client-side computing} --
the concept that a client can
receive and execute code,
turning web pages from documents
into dynamic and increasingly interactive pieces of software
\parencite{jac2019}.
Today, software built \enquote{for the web} refers most often to client-side applications
...
since a modern web map is usually a heavily client-side application \parencite{rot2014}.
...
This type of website, or web application, is called a \emphasizeacr{spa}.
Such applications can implement complex functionality and a high degree of interactivity,
remaining responsive due to fetching only what is necessary after the initial page is loaded
\parencite{mai2017}.
...
At the most essential level are 
