...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.6\textwidth}
		\centering
		\includegraphics[width=\textwidth]{visual/figures/photos/paper_interactive_map.png}
		\caption{Paper}
	...
	\begin{subfigure}[b]{0.6\textwidth}
		\centering
		\includegraphics[width=\textwidth]{visual/figures/screenshots/digital_interactive_map.png}
		\caption{TODO}
		\label{fig:digital interactive map}
	\end{subfigure}
	\caption{Different types of interactive maps}
	\label{fig:interactive map types}
\end{figure}
