...
However, cartography,
not as in the practice of mapmaking but as an established science,
is much younger, dating back only to the early 1900s \parencite{woo2003, kai2020}.
In the time since then,
change has been a constant in the scientific discourse in cartography \parencite{mac2004} --
% the discipline has reinvented itself many times.
the discipline is as dynamic as the topics that people map,
...
It should be also be noted that even if a definition is agreed upon,
