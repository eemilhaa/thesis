...
\subsubsection{Defining "cartographic interaction" and "interactive map"}
...
and interaction exchange \parencite{rot2013a}.
...
A theoretical framework of interaction, such as \textcite{rot2011, rot2012, nor1988},
...
These are often categorized into 4 main styles:
...
A common example would be a case when the \textit{pan} operator primitive
...
One distinction that is often made in the context of cartographic interaction
is the amount of direct map manipulation in relation to other interaction styles.
If map manipulation happens mostly through
interaction styles other than direct manipulation,
...
A desktop \acrshort{gis} software could represent the former type of interface,
and a simple web map the latter. % TODO add fig
...
differentiation here is whether the interaction happens by
direct manipulation of the map itself, or through some other style of interface.
These other interfaces 
% user interface styles
In addition to what the exchange consists of (interaction primitives), 
If interaction primitives can be used in conceptualizing interaction exchanges
