...
thus establishing the technological premise for
...
an input device for processing user input into a digital form, and an output device for
conveying the state of the program to the user.
...
of the system.
This directly contributes to the user's experience of interactivity.  % TODO ref
