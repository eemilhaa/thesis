...
With the implementation process, my first goal was to pinpoint
...
This is an important consideration for the design of map interfaces in general,
as such loss of detail could potentially lead to
...
Many of the tradeoffs above in no way inherent to cartographic interaction.
