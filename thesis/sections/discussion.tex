...
In general, to provide reliability to my results and value to the implementation,
I crafted the technical components of the study in a highly reproducible manner:
Not only is the application reproducible in the sense of available source code,
but also in the sense that its components are
automatically packaged and published as functional container images.
Also, the deployment of the application is done declaratively,
meaning that instead of relying on a manual effort,
it too can be automatically and reliably reproduced.
