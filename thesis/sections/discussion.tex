...
the cartographic method, only applied with the relevant technologies \parencite{rot2021}.
In the second case,
...
a person that is often connected to \enquote{covering the responsibility of an entire IT
