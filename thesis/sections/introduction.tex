...
\begin{itemize}
	...
	\item What data preprocessing approaches are most effective at
	optimizing the performance of the system?
\end{itemize}  % TODO maybe list approaches -> which is best? Geometry simplification etc...
I answer this question by evaluating approaches based on three criteria:
\begin{enumerate}
...
I evaluate the first criterion quantitatively.
When evaluating the second criterion,
...
I evaluate the third criterion qualitatively.

\begin{itemize}
	\item What data storage and serving approach is most effective at
	optimizing the performance of the system?
\end{itemize}

I answer this question by a qualitative assessment of the available options.
I also test whether the result is
applicable to my use case by using it as my back end solution.

\begin{itemize}
	\item What differences are there between web-mapping libraries
	when rendering rapidly changing data?
\end{itemize}

I answer this question by evaluating different web-mapping libraries based on three criteria:
\begin{enumerate}
...
\begin{itemize}
	...
	\item Does map interaction change the map user's perception of accessibility? If it does, how?
\end{itemize}
...
The implementation can be judged by if, and how well, it works when used by real people.
