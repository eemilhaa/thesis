...
The research questions necessary to producing this particular map presentation are:
\begin{enumerate}
	\item How to simplify a complex accessibility dataset to be suitable for interactive mapping?
	\item How to serve and render geographic data fast enough to enable instantaneous interaction?
