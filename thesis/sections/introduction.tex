...
cartographic interaction redistributes the agency in how maps work.
Instead of only a reader, the map user has the capability of actively manipulating the map,
and the map, in turn, has the capability of adapting to the manipulation.
From such user-map exchanges emerges a dialogue:
By perceiving and evaluating the results of map manipulation
A simultaneous blend of mapmaking and -reading
The ability to interact with spatial data through map interfaces has
been shown to
