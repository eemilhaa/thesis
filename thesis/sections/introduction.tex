...
Instead of only a reader, the map user has the capability of actively manipulating the map,
...
\parencite{rot2011}.
Such map use as a blend of simultaneous mapmaking and -reading
is considered highly conductive to analytical thinking and reasoning
with spatial data,
enabling new ways to solve novel and increasingly complex problems \parencite{rob2017b, and2010}.

For the already highly multidisciplinary science of cartography,
understanding and crafting cartographic interaction necessitates an even
more diverse set of research themes and methods.
...
\parencite{rot2013b}.
Studying how the map interface is used, perceived and reasoned with
means a tight integration of the user into the cartographic process
by empirical user studies \parencite{rot2017}
...
more and more resemble those of a software developer.
This comes also with the
to applications


Understanding and crafting ew 
% What is the state of interactive cartography
process of cartographic interaction.
...
\subsubsection{Usage of the map}  % TODO
