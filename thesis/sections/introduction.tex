...
In this thesis I focus on how cartographic interaction can be utilized in presenting accessibility.
I approach this theme with two sub-topics.
The first deals with the technical aspects of producing an interactive accessibility visualisation.
...
that all must meet the requirements real-time interactivity entails.
The research questions that must be answered to enable this particular map presentation are:
\begin{enumerate}
	\item What data processing steps are needed to make a massive accessibility dataset explorable interactively over the internet?
