...
Accessibility, in this geographical sense,
is deeply interlinked in our society.

However, accessibility is an intricate topic to analyse or present.
The general starting point for defining the term is often
\enquote{potential of opportunities for interaction} \parencite{han1959},  % define interaction in more detail?
but, depending on the factors considered impactful to that potential,
...
including all the different things these can be measured in relation to
...
Because of the very complex nature of the phenomenon,
constructing cartographic presentations of accessibility is intricate.
...
interactive visualisations could offer some benefits.
...
especially in the context of interactive cartography.
