...
As such,
cartographic interaction, for example in the form of online or mobile map applications,
can be seen to facilitate the access to spatial information
...
striving for such a presentation. % an interactive, dynamic and responsive display of complex data.
