...
Firstly, how can map interaction be utilized in presenting spatial accessibility?
To answer this question,
a framework for interactively presenting a massive accessibility dataset on the web is developed.
A framework in this context means that, in addition to a visualisation,
an implementation of this scale requires other components too.
These components include
an approach for preprocessing complex data to make it more suitable for interactive visualisation,
