...
\begin{itemize}
	...
	% \item Do people perceive the accessibility of a location differently on an interactive map?
	% \item Does map interaction change the map user's understanding of the concept of accessibility? If it does, how?
