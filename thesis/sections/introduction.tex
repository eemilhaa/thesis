...
\subsubsection{An interactive travel time map}
...
The ultimate purpose of the entire system is to enable
a cartographic presentation -- a map.
The map, in turn, is a means to represent the mapped phenomenon 
to the map user.  % TODO
How, and if, the map works at this goal is impossible to judge based on
the technical implementation alone.

My second research goal is to understand how the map works
as a representation as well as an interface.
By representation I mean how the map user understands the map and by interface
how they use the map to explore the mapped phenomenon.
For this, a user perspective is key.
...
\subsubsection{Understanding the map as a representation and an interface}
