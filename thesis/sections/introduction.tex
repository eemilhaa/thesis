...
a cartographic representation -- a map.
...
My second research goal is to understand the 
So, my second research goal is to gain insight on how the map user understands the representation

I an attempt to better understand how the map functions,
I include the perspective of the map user,
...
\subsubsection{Gaining a user perspective of the map}
