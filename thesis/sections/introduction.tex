...
Currently we live in a world that is in a state of rapid, and on many fronts alarming, change (cite sdgs).
Simultaneously data, often massive in size, is available to excess rather than a scarcity.
The United Nations (UN) highlights amount of data, (more problems here)
