...
they help us reveal and understand completely new patterns and phenomena,
and to gain insights from information
that would otherwise be hard or impossible to comprehend.
Currently we live in a world that is in a state of rapid,
and on many fronts alarming, change \parencite{un2023}.
Simultaneously, data, often massive in size, is available to excess rather than a scarcity.
The United Nations (UN) notes that efficiently harnessing data
is one of the most pressing challenges (mention potential too)for the ongoing century.
\parencite{un2020}
...
% https://www.un.org/en/content/datastrategy/index.shtml  UN data-strategy

% Cartography in change too
% new methods, new topics unlocked
