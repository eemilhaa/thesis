...
explore the whole dataset with instant visual feedback,
i.e. in real-time,
and, in general, with as little restrictions as possible.
...
So, while being a map first and foremost, this particular presentation
...
I focus my second goal on the human aspect of map use.
...
This necessitates research on the options and tools
...
\begin{itemize}
	...
	\item What types of preprocessing steps are most effective at minimizing
	latency when exploring large volumes of geographic data over the internet?  % Mapping, transfer
	\item What type of data storage and serving approach is most effective at the same goal?
\end{itemize}

From the perspective of usability:
\begin{itemize}
	\item What are the pros and cons of different web-mapping libraries considering
	1. the visual quality and 2. the rendering speed of the map when mapping geometrically complex data
\end{itemize}
